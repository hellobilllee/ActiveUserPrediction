...
def get_user_from_videoCreate(laterThanDay,videoCount):
    ...
    df_video_create = pd.read_table("data/A2/video_create_log.txt",header=None,names=video_create_log,index_col=None,dtype=dtype_video_create)
...
def get_user_from_appLaunch(laterThanDay,launchCount):
    ...
    df_app_launch = pd.read_table("data/A2/app_launch_log.txt",header=None,names=app_launch_log,index_col=None,dtype=dtype_app_launch)
...
def get_user_from_userRegister(laterThanDay):
    ...
    df_user_register = pd.read_table("data/A2/user_register_log.txt",header=None,names=user_register_log,index_col=None,dtype=dtype_user_register)
...
def get_user_from_userActivity(laterThanDay,dayCount,pageList,typeList):
    ...
    df_user_activity = pd.read_table("data/A2/user_activity_log.txt",header=None,names=user_activity_log,usecols=usecols,index_col=None,dtype=dtype_user_activity)
...
# get_user_from_userActivity(18, 3, [1,2,3], [1,3,4,5])

def get_user():

    user_videoCreate = get_user_from_videoCreate(24, 1)
    user_appLaunch = get_user_from_appLaunch(24, 3)
    user_userRegister = get_user_from_userRegister(27)
    user_userActivity = get_user_from_userActivity(27, 3, [1], [3,4,5])
    ...
    submission_file = "result/submission_h_" + str_time + ".csv"
